    ...
    $.fn.extend({
        ...
        accessibleTabs: function(config) {
            ...
            return this.each(function(t) {
                ...
                var header = $(el).find(o.options.tabhead + "." + o.options.tabheadClass);
                if(header.length > 0) {
                    $(header).hide();
                    $(header[0]).show().focus();
                }

                $(el).find("ul"+o.getClassSelectorsFromClassNames(o.options.tabsListClass)+">li:first")
                  .addClass(o.options.currentClass).addClass(o.options.firstNavItemClass)
                ...
                $(el).find('ul'+o.getClassSelectorsFromClassNames(o.options.tabsListClass)+'>li>a').each(function(i){
                    $(this).click(function(event){
                        ...
                        $(el).find(o.options.tabhead + "." + o.options.tabheadClass+':visible').hide();
                        $(el).find(o.options.tabhead + "." + o.options.tabheadClass).eq(i)[o.options.fx](o.options.fxspeed);
